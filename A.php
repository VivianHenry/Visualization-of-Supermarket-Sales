        ...
        <div class="dashboard_body">
          <div class="card">
            <div class="card_head" style="background-color:#1a1a1a; border-color:#08827F">
              <h2 style="color:white; text-align:center">Welcome to Branch A!</h2>
            </div>
            <div class="card_body">
              <div class="row align-items-start">
                <div class="col-3" style="background-color:#0066cc; border-color:#0066cc; text-align: center">
                  <?php
                    $avg_income = avg_daily_income_A();
                ...
                <div class="col-3" style="background-color:#cc3300; border-color:#0066cc; text-align: center">
                  <?php
                    $avg_cogs = avg_daily_expense_A();
                    echo "<h5 style>Average Daily Expense ($): $avg_cogs</h5>";
                  ?>
                </div>
                <div class="col-3" style="background-color:#0066cc; border-color:#0066cc; text-align: center">
                  <?php
                    $avg_gross_margin_percentage = avg_daily_profit_margin_A();
                ...
                <div class="col-3" style="background-color:#00b33c; border-color:#0066cc; text-align: center">
                  <?php
                    $avg_rating = avg_customer_rating_A();
              ...
              <div class="row align-items-start">
                <div class="col-6">
                  <div id="area_chart_revenue_A" style="background-color:#1a1a1a; border-color:#08827F; text-align: left">
                      <script src="area_chart_revenue_A.js"></script>
                  </div>
                </div>
                <div class="col-6">
                  <div id="area_chart_cost_A" style="background-color:#1a1a1a; border-color:#08827F; text-align: left">
                      <script src="area_chart_cost_A.js"></script>
                  </div>
                </div>
                <hr>
                <div class="col-6">
                  <div id="bar_graph_A" style="background-color:#1a1a1a; border-color:#08827F; text-align: left">
                      <script src="bar_graph_A.js"></script>
                  </div>
                </div>
                <div class="col-6">
                  <div id="bar_graph_gender_A" style="background-color:#1a1a1a; border-color:#08827F; text-align: left">
                      <script src="bar_graph_gender_A.js"></script>
                  </div>
                </div>
                <hr>
                <div class="col">
                  <div id="scatterplot_matrix_A" style="background-color:#1a1a1a; border-color:#08827F; text-align: center">
                      <script src="scatterplot_matrix_A.js"></script>
                  </div>
                </div>
                <hr>
              </div>
