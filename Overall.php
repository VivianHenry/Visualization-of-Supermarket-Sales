        ...
        <div class="dashboard_body">
          <div class="card">
            <div class="card_head" style="background-color:#1a1a1a; border-color:#08827F">
              <h2 style="color:white; text-align:center">Welcome to the Company Dashboard!</h2>
            </div>
            <div class="card_body">
              <div class="row align-items-start">
                <div class="col-3" style="background-color:#0066cc; border-color:#0066cc; text-align: center">
                  <?php
                    $avg_income = avg_daily_income_Overall();
                ...
                <div class="col-3" style="background-color:#cc3300; border-color:#0066cc; text-align: center">
                  <?php
                    $avg_cogs = avg_daily_expense_Overall();
                    echo "<h5 style>Average Daily Expense ($): $avg_cogs</h5>";
                  ?>
                </div>
                <div class="col-3" style="background-color:#0066cc; border-color:#0066cc; text-align: center">
                  <?php
                    $avg_gross_margin_percentage = avg_daily_profit_margin_Overall();
                ...
                <div class="col-3" style="background-color:#00b33c; border-color:#0066cc; text-align: center">
                  <?php
                    $avg_rating = avg_customer_rating_Overall();
              ...
              <div class="row align-items-start">
              <div class="col-6">
                  <div id="bar_product_line" style="background-color:#1a1a1a; border-color:#08827F; text-align: left">
                    <script src="bar_product_line_Overall.js"></script>
                  </div>
              </div>
                <div class="col-6">
                  <div id="bar_revenue_cost_rating_Overall" style="background-color:#1a1a1a; border-color:#08827F; text-align: left">
                    <button onclick="update('Revenue')" class="btn btn-success">Avg. Daily Revenue($)</button>
                    <button onclick="update('Cost')" class="btn btn-danger">Avg. Daily Cost($)</button>
                    <button onclick="update('Rating')" class="btn btn-light">Avg. Rating out of 10</button>
                    <script src="bar_revenue_cost_rating_Overall.js"></script>
                  </div>
                </div>
                <hr>
                <div class="col-4">
                  <div id="pie_customer_gender_Overall" style="background-color:#1a1a1a; border-color:#08827F; text-align: left">
                      <script src="pie_customer_gender_Overall.js"></script>
                  </div>
                </div>
                <div class="col-4">
                  <div id="pie_customer_type_Overall" style="background-color:#1a1a1a; border-color:#08827F; text-align: left">
                      <script src="pie_customer_type_Overall.js"></script>
                  </div>
                </div>
                <div class="col-4">
                  <div id="pie_payment_method_Overall" style="background-color:#1a1a1a; border-color:#08827F; text-align: left">
                      <script src="pie_payment_method_Overall.js"></script>
                  </div>
                </div>
                <hr>
                <div class="col-12">
                  <div id="streamgraph_revenue" style="background-color:#1a1a1a; border-color:#08827F; text-align: center">
                      <script src="streamgraph_revenue.js"></script>
                  </div>
                </div>
                <hr>
                <div class="col-12">
                  <div id="streamgraph_cost" style="background-color:#1a1a1a; border-color:#08827F; text-align: center">
                      <script src="streamgraph_cost.js"></script>
                  </div>
                </div>
                <hr>
              </div>
